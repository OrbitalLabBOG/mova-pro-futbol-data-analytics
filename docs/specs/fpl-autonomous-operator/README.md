...
| [04-readiness-and-rollout.md](04-readiness-and-rollout.md) | **Única hoja de ruta vigente:** cierre del 20/09, nueve entregables, criterios y dependencias |
...
| [10-autonomous-harness-v1.md](10-autonomous-harness-v1.md) | arquitectura y construcción histórica: Postgres, CLI/skill, roles, memoria, costos, ejecución y mejora continua |
...
| 17-hv1-06b-deliberation-evidence.md (referencia histórica: archivo ausente en este checkout) | Strategist + Critic acotados, intervención shadow y replay vivo corregido |
| [20-hv1-07d-dom-probe.md](20-hv1-07d-dom-probe.md) | DOM probe autenticado y planner R2 fail-closed |
| 21-hv1-08-improvement-rollout.md (referencia histórica: archivo ausente en este checkout) | Gate propuesta→lección, costos explícitos y reconciliación de incidentes |
| 22-hv1-08-budget-rollout.md (referencia histórica: archivo ausente en este checkout) | Budgets persistentes, reservas atómicas y observabilidad de costo |
| 23-hv1-08-causal-reviewer-rollout.md (referencia histórica: archivo ausente en este checkout) | Reviewer causal post-settlement y propuestas multi-GW |
...
[Cierre de autonomía operativa](04-readiness-and-rollout.md); 10 conserva arquitectura, 08 y 09 son referencias de diseño y
hardening diferido.
