...
> así. Para **operar** una jornada → [runbook de jornada](../operations/gameweek.md). Para el
> registro de diseño con las alternativas que se descartaron →
> [spec del decision engine](../specs/fpl-decision-engine/).
>
...
| Entender por qué se eligió X y no Y | [specs/…/02-architecture.md](../specs/fpl-decision-engine/02-architecture.md) y los ADRs |
| Ver la evidencia de un criterio | [specs/…/evidence/](../specs/fpl-decision-engine/evidence/) |
| Trabajar en el código | [AGENTS.md](../../AGENTS.md) |
