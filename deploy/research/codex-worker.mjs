...
try {
  ...
  if (!selected) process.exitCode = 75;
    ...
    const researchPrompt = [
      ...
      "Cumple literalmente request.scope_policy. Los máximos de documents y señales",
      "se validan al importar. Codex no expone al host todas las búsquedas internas:",
