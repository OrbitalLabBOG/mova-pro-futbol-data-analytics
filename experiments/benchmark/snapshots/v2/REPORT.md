...
Catálogo: 25 directorios; grupos pareados: 12.
...
## exp022-external_diagnostic-v1

Persistencia Markov de oportunidades vs season_value 1.0.0; predictores aislados y hashes de proyección pareados en 38 GWs; h3/top20/CBC3s. Temporada ya consultada.

Fase: `external_diagnostic`. Temporadas: 2025-26.

| Variante | PVA-38 por temporada (orden anterior) | Media | Gana/pierde | IC95 registrado |
| --- | --- | ---: | --- | --- |
| markov_season_value | +0 | +0.00 | 0/0 | [+0.0, +0.0] |

Evidencia: `EXP-MOVA-2026-022-isolated/2025-26-season_value-replay.json`, `EXP-MOVA-2026-022-isolated/2025-26-markov_season_value-replay.json`, `EXP-MOVA-2026-022-isolated/manifest.json`, `EXP-MOVA-2026-022-isolated/policy-evaluation.json`.
...
### exp022-opportunity-transition

37 oportunidades de entrenamiento 2023/24; 36 transiciones de evaluación 2024/25. Valores del solver, no puntos realizados. Energy score conjunto y MSE escalados con entrenamiento; menor es mejor.

| Variante | energy_score | mean_squared_error |
| --- | ---: | ---: |
| stationary | 1.06173 | 0.689251 |
| markov | 1.02441 | 0.643928 |

Evidencia: `EXP-MOVA-2026-022/mechanism-evaluation.json`.
...
- Los agregados anteriores se conservan como evidencia reportada. EXP022 sí reejecuta dos brazos completos; sus reintentos no cuentan como temporadas independientes.
...
- El benchmark no cambia modelos activos ni autoridad del harness; MLflow registra evidencia del contrato y no promueve políticas.
- EXP-MOVA-2026-022 conserva una primera comparación invalidada por predictor mutable compartido. Sus totales no entran al ranking; el único replay de política registrado es EXP-MOVA-2026-022-isolated.
...
| EXP-MOVA-2026-022 | 7 | 0 |
| EXP-MOVA-2026-022-isolated | 8 | 1 |
